...
CREATE DATABASE [Stocks]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Stocks', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\Stocks.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Stocks_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\Stocks_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [Stocks] SET  ENABLE_BROKER 
GO
...
ALTER DATABASE [Stocks] SET RECOVERY FULL 
GO
